pipeline {
    ...
    environment {
        ...
        GITCredentials = "${env.GIT_CRED}" // Update this with the ID of your new credentials
        ...
        stage('download integration artefact and store it in GitHub') {
            steps {
                ...
                script {
                    ...
                    println("Deleting old flow content...")
                    ...
                    println("Storing integration artefact in Git...")
